...
func treatProduction(db *sql.DB, prodId int64) {
	...
	f1, err := os.OpenFile("/home/sidleal/usp/coling2018/2_sentences.txt", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
		log.Println("ERRO", err)
	}
	defer f1.Close()

	f2, err := os.OpenFile("/home/sidleal/usp/coling2018/2_aligns.txt", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
		log.Println("ERRO", err)
	}
	defer f2.Close()
