...
func main() {
	...
	f1, err := os.OpenFile("/home/sidleal/usp/coling2018/v1/validacao_ori.tsv", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
		log.Println("ERRO", err)
	}
	defer f1.Close()

	f2, err := os.OpenFile("/home/sidleal/usp/coling2018/v1/validacao_nat.tsv", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
		log.Println("ERRO", err)
	}
	defer f2.Close()

	f3, err := os.OpenFile("/home/sidleal/usp/coling2018/v1/validacao_str.tsv", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
		log.Println("ERRO", err)
	}
	defer f3.Close()

	sizeSentOri := readFile("/home/sidleal/usp/coling2018/v1/align_size_ori.tsv")
	...
	sizeSentNat := readFile("/home/sidleal/usp/coling2018/v1/align_size_nat.tsv")
	...
	metrics := readFile("/home/sidleal/usp/coling2018/v1/pss_sentences_metrics.tsv")
	...
	// 		if itemNat.TextA == itemOri.TextB && itemOri.TextA != itemOri.TextB && itemNat.TextA != itemNat.TextB {
	// 			log.Println("----------------")
